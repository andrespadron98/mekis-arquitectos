        ...
        <div class="navbar">
            ...
            <nav class="collapse-nav is-visible">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link {{ Request::is('contacto*') ? 'active' : '' }}" href="{{ route('contacto') }}">Contacto</a></li>
                </ul>
            </nav>
        </div>
        <div class="title">
...
<header id="mobile" class="header index-sec">
    <div class="container-fluid">
        <div class="name">
            <a class="btn-collapse-nav" id="btn-collapse-nav" href="#0"><span class="menu-icon"></span></a>
            <div class="name-site"><p>A&amp;L MEKIS<br><small>ARQUITECTOS</small></p></div>
        </div>
        <div class="navbar">
