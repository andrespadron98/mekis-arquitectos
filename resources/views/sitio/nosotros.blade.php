...
@section('descripcion', 'A&L Mekis Arquitectos es un estudio familiar de arquitectura y construcción en Chile, fundado en 1993 por Andrés Mekis y continuado junto a León Mekis.')
@section('contenido')
    ...
    <div class="container container-lg">
        ...
        <div class="row">
            <div class="col-12 col-lg-4 px-3">
                <img loading="lazy" decoding="async" src="assets/images/nosotros/andres.jpeg" class="img-fluid" alt="Andrés Mekis, arquitecto">
                <div class="pt-4">
            ...
            <div class="col-12 col-lg-4 px-3">
                <img loading="lazy" decoding="async" src="assets/images/nosotros/leon.jpg" class="img-fluid" alt="León Mekis, arquitecto">
                <div class="pt-4">
